  ...
  12:	31 db                	xor    %ebx,%ebx
{
  ...
  1f:	e8 2c 04 00 00       	call   450 <printf>
    sleep(10);
  24:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
  2b:	e8 53 03 00 00       	call   383 <sleep>
  ...
  3c:	83 c3 01             	add    $0x1,%ebx
        printf(1,"allocating new page for %d\n",i);
  3f:	68 c5 07 00 00       	push   $0x7c5
  44:	6a 01                	push   $0x1
  46:	e8 05 04 00 00       	call   450 <printf>
        sbrk(4096);
  4b:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  52:	e8 24 03 00 00       	call   37b <sbrk>
        printf(1,"check page table \n");
  57:	58                   	pop    %eax
  58:	5a                   	pop    %edx
  59:	68 e1 07 00 00       	push   $0x7e1
  5e:	6a 01                	push   $0x1
  60:	e8 eb 03 00 00       	call   450 <printf>
        sleep(10);
  65:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
  6c:	e8 12 03 00 00       	call   383 <sleep>
    for(int i=0;i<20;i++){
  71:	83 c4 10             	add    $0x10,%esp
  74:	83 fb 14             	cmp    $0x14,%ebx
  77:	75 bf                	jne    38 <main+0x38>
    }
    sleep(30);
  79:	83 ec 0c             	sub    $0xc,%esp
  7c:	6a 1e                	push   $0x1e
  7e:	e8 00 03 00 00       	call   383 <sleep>
    exit();
...
free(void *ap)
{
 ...
 625:	a1 a8 0a 00 00       	mov    0xaa8,%eax
{
 ...
 646:	73 10                	jae    658 <free+0x38>
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	a3 a8 0a 00 00       	mov    %eax,0xaa8
}
 677:	5e                   	pop    %esi
 678:	5f                   	pop    %edi
 679:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6bd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6c0:	8b 3d a8 0a 00 00    	mov    0xaa8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
